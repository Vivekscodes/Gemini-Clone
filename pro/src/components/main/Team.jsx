      ...
      <div className="card">
        ...
        <div className="bottom">
          <div className="content">
            <span className="name">Vivek Singh</span>
            <span className="about-me">FrontEnd Developer</span>
          </div>
          <div className="bottom-bottom">
            <div className="social-links-container">
              <a href="https://github.com/Vivek1238o" target="_blank">
                <svg
                  xmlns:xlink="http://www.w3.org/2000/svg/xlink"
                  x="0px"
                  y="0px"
                  width="100"
                  height="100"
              ...
              <a
                href="https://www.linkedin.com/in/vivek-singh-65a69924b/"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
